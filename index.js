...
app.get('/movie/director/:directorId', (req, res) => {
...
app.get('/movie/genre/:genreId', (req, res) => {
...
app.post('/user/:Name/movie/:MovieID', (req, res) => {
  User.findOneAndUpdate(
    { Name: req.params.Name },
    {
...
app.delete('/user/:Name/movie/:MovieID', (req, res) => {
  User.findOneAndUpdate(
    { Name: req.params.Name },
    {
